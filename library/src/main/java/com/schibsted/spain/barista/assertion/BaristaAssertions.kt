@file:JvmName("BaristaAssertions")
 ...
 */
inline fun <reified T : View> assertAny(
  resId: Int,
  assertionErrorMessage: String? = null,
...
inline fun <reified T : View> assertAny(
  ...
  assertAnyView(
    viewMatcher = matcher,
    condition = BooleanMatcher(assertionErrorMessage, block) as Matcher<View>
  )
}
